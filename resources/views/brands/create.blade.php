    ...
    <form action="/admin/brands" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-10 mx-auto">
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('logos') is-invalid @enderror" type="file" id="image1" name="logos" onchange="previewImage()">
                @error('logos')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('signature') is-invalid @enderror" type="file" id="image2" name="signature" onchange="previewImage2()">
                @error('signature')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
